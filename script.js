...
// changedTouches - список пальцев, которые учавствуют в текущем событии(напр, если это событие touchend, то список будет содержать палец, который был убран, даже если остальные пальцы до сих пор на экране. Т.е. это именно те пальцы, которые уже совершили назначенное действие)
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    box.addEventListener('touchmove', (event) => {
        ...
        console.log('Move');
        console.log(event.targetTouches[0].pageX); //отслеживает положение первого пальца на экране
    });
